...
**Created**: 2026-07-23
**Status**: In Progress — User Stories 1, 3, 4, 5, 6 Implemented (real backend); User Story 2 true by construction; form validation (FR-010) implemented; FR-011–FR-018 implemented and verified against the real `dine-out-backend`; FR-019 (password show/hide toggle) implemented 2026-09-02
