...
**Status**: Implemented
**Entry points**: bottom tab "Search", **Flow 3** step 3i, **Flow 4** step 4c, **Flow 5** step 5c
...
**Entry points**: bottom tab "Profile", **Flow 8** step 8b/8c, **Flow 6** step 6r, **Flow 2** step 2c
...
11c. Tap "+ Add new address" → add-address form sheet — **Not Started**.
11d. Tap "Pick on map" → `[NEEDS CLARIFICATION: real pin-drop or simulated, like this prototype's other redirect affordances?]` — **Not Started**.
11e. Fill the form, tap "Save address" → `[NEEDS CLARIFICATION: does this persist to a store, or simulate like the rest of the prototype?]` — **Not Started**.
