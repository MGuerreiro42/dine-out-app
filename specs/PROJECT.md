...
| `auth` | `specs/auth.md` | Spec drafted (4 user stories), not implemented — no `features/auth/` folder scaffolded yet, unlike the others (see ADR log) |
