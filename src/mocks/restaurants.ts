...
const SEEDS: PlaceSeed[] = [
  ...
  { id: '4', name: 'Costelaria do Vale', formattedAddress: 'Rua Harmonia, 88 - Vila Madalena, São Paulo - SP', location: { latitude: -23.554, longitude: -46.6883 }, rating: 4.5, userRatingCount: 420, priceLevel: PRICE.mid, primaryType: 'brazilian_restaurant', occasion: 'encontro', ambient: 'cozy', photoPoolIndex: 2 },
  ...
  { id: '10', name: 'Costa Azul Meze', formattedAddress: 'Alameda Lorena, 1500 - Jardins, São Paulo - SP', location: { latitude: -23.567, longitude: -46.6716 }, rating: 4.3, userRatingCount: 300, priceLevel: PRICE.high, primaryType: 'mediterranean_restaurant', occasion: 'grupo', ambient: 'fancy', photoPoolIndex: 4 },
  ...
  { id: '16', name: 'Pasta & Vino', formattedAddress: 'Alameda Gabriel Monteiro da Silva, 350 - Jardins, São Paulo - SP', location: { latitude: -23.5688, longitude: -46.6698 }, rating: 4.7, userRatingCount: 520, priceLevel: PRICE.high, primaryType: 'italian_restaurant', occasion: 'encontro', ambient: 'fancy', photoPoolIndex: 2 },
  ...
  { id: '22', name: 'Namaste Cozinha Indiana', formattedAddress: 'Rua Bela Cintra, 1620 - Jardins, São Paulo - SP', location: { latitude: -23.5706, longitude: -46.668 }, rating: 4.6, userRatingCount: 410, priceLevel: PRICE.mid, primaryType: 'indian_restaurant', occasion: 'familia', ambient: 'cozy', photoPoolIndex: 5 },
  ...
  { id: '28', name: 'Casa do Bambu', formattedAddress: 'Rua da Glória, 290 - Liberdade, São Paulo - SP', location: { latitude: -23.5634, longitude: -46.6332 }, rating: 4.5, userRatingCount: 350, priceLevel: PRICE.mid, primaryType: 'chinese_restaurant', occasion: 'familia', ambient: 'cozy', photoPoolIndex: 4 },
  { id: '29', name: 'Lanterna Vermelha', formattedAddress: 'Rua São Joaquim, 100 - Liberdade, São Paulo - SP', location: { latitude: -23.5616, longitude: -46.6314 }, rating: 4.4, userRatingCount: 310, priceLevel: PRICE.high, primaryType: 'chinese_restaurant', occasion: 'grupo', ambient: 'fancy', photoPoolIndex: 3 },
  { id: '30', name: 'Templo do Sabor', formattedAddress: 'Rua Barão de Iguape, 300 - Liberdade, São Paulo - SP', location: { latitude: -23.5598, longitude: -46.6386 }, rating: 4.0, userRatingCount: 140, priceLevel: PRICE.low, primaryType: 'chinese_restaurant', occasion: 'musica', ambient: 'agitated', photoPoolIndex: 6 },
];
